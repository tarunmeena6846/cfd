...
public class AnagramsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.util.Log.e("Anagram Activity", "1");
        ...
        android.util.Log.e("Anagram Activity", "2");
        ...
        android.util.Log.e("Anagram Activity", "3");
    }
    ...
    public boolean defaultAction(View view) {
        ...
        if (currentWord == null) {
            ...
            android.util.Log.e("AnagramActivity", anagrams.toString());
